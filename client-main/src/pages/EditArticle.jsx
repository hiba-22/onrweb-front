...
const EditArticle = () => {
    ...
    const { isPending, isError, data: article, error } = useQuery({
        ...
        queryFn: () =>
            getSingleHandler(`https://onrtech-back-52ii77f9c-hiba-21s-projects.vercel.app/api/v1/articles/${id}`),
    });
    ...
    const updateArticleMutation = useMutation({
        mutationFn: async (formData) => {
            const response = await axios.put(
                `https://onrtech-back-52ii77f9c-hiba-21s-projects.vercel.app/api/v1/articles/${id}`,
                formData,
                {
                    headers: {
        ...
        onSuccess: (data) => {
            queryClient.invalidateQueries({ queryKey: ["updateArticle"] });
            Swal.fire({
                icon: "success",
                    ...
                    <form autoComplete="off" onSubmit={handleSubmit(onSubmit)} encType="multipart/form-data">
                        <div className="form-1">
                            ...
                            <div className="row">
                                ...
                                <select
                                    defaultValue={article?.isPublished}
                                    name="isPublished"
                                    id="isPublished"
