...
const ManageUsers = () => {
    ...
    const {
        ...
        queryKey: ["users"],
        queryFn: () =>
            getAllHandler(`https://onrtech-11tcm8niu-hiba-21s-projects.vercel.app//api/v1/users`),
    });
    ...
    const UpdateUserRole = async (id, role) => {
        ...
        try {
            const response = await axios.patch(
                `https://onrtech-11tcm8niu-hiba-21s-projects.vercel.app//api/v1/admin/update-role`,
                updateUser,
