...
const EditProfile = () => {
    ...
    const onSubmit = async (data) => {
        ...
        formData.append("resume", data.resume[0]); // Get the file
    ...
    // Fonction pour extraire le nom du fichier à partir de l'URL complète
                        ...
                        <div className="profile-form">
                            ...
                            <div className="row">
                                ...
                                <input
                                    ...
                                    name="resume"
                                    {...register("resume", {
                                        required: false, // Not required if just displaying existing resume
                                    })}
                                />
                                {errors?.resume && (
                                    <span className="text-[10px] font-semibold text-red-600 mt-1 pl-1 tracking-wider">
