...
const AddService = () => {
    ...
    const { fields: principaux_outils_expertsFields, append: appendprincipaux_outils_experts, remove: removeprincipaux_outils_experts } = useFieldArray({ control, name: "principaux_outils_experts" });
    ...
    const onSubmit = async (data) => {
        ...
        data.principaux_outils_experts.forEach(principaux_outils_experts => formData.append("principaux_outils_experts", principaux_outils_experts));
        ...
        try {
            const response = await axios.post(
                "https://onr-backend.vercel.app/api/v1/Services",
                formData,
                {
                    ...
                    <form autoComplete="off" onSubmit={handleSubmit(onSubmit)}>
                        <div className="form">
                            ...
                            <div className="row">
                                ...
                                {principaux_outils_expertsFields.map((item, index) => (
                                    <div key={item.id} className="flex items-center">
                                        <input
                                            type="text"
                                            {...register(`principaux_outils_experts.${index}`, { required: "This field is required" })}
