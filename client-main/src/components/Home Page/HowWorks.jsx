...
import { useTranslation } from "react-i18next";
  ...
  export default function HowWorks() {
    ...
    return (
      <div  style={backgroundStyle} className="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
          <img
            ...
            <dl className="mt-16 grid grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-2 lg:grid-cols-4">
              {stats.map((stat) => (
                <div key={stat.name} className="flex flex-col-reverse">
                  ...
                  <dt className="text-6xl font-bold leading-9 tracking-tight text-white"><i className={stat.iconClass}></i></dt> 
                </div>
              ))}
            </dl>
          </div>
